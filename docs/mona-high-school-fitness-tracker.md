...
- Update #file:monafit-tracker/backend/monafit_tracker/views.py to replace the return for the rest api url endpiints with the codespace url http://animated-tribble-7vx7xwq5wqr3rxw-8000.app.github.dev for django
- Replace <codespace-name> with animated-tribble-7vx7xwq5wqr3rxw
...
@api_view(['GET'])
def api_root(request, format=None):
    base_url = 'http://animated-tribble-7vx7xwq5wqr3rxw-8000.app.github.dev/'
    return Response({
        'users': base_url + 'api/users/?format=api',
        'teams': base_url + 'api/teams/?format=api',
        'activities': base_url + 'api/activities/?format=api',
